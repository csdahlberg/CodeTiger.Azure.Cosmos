...
/// <summary>
/// A visitor that builds the body of a JavaScript function for a stored procedure to create a result object from
/// an aggregate object.
/// </summary>
internal static class CreateResultVisitor
{
    ...
    /// to create a result object from an aggregate object.
    /// </summary>
    ...
    /// <remarks>The function accepts one parameter, <c>aggregate</c>. It returns a result object created from an
    /// aggregate object.</remarks>
