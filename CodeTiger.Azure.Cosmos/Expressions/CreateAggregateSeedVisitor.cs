...
/// <summary>
/// A visitor that builds the body of a JavaScript function for a stored procedure to create an initial aggregate
/// element from a source element.
/// </summary>
internal static class CreateAggregateSeedVisitor
{
    ...
    /// to create an initial aggregate element from a source element.
    /// </summary>
    /// <param name="expression">The <see cref="Expression"/> to visit.</param>
    /// <returns>The body of a JavaScript function for a stored procedure to create an initial aggregate element
    /// from a source element.</returns>
    /// <remarks>The function accepts one parameter, <c>first</c>. It returns an initial aggregate object created
    /// from data in that first source object..</remarks>
