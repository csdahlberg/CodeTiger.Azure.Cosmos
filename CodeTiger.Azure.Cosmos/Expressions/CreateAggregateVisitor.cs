...
{
    /// <summary>
    /// A visitor that builds the body of a JavaScript function for a stored procedure to create aggregate elements
    /// by combining the existing aggregate element with another source element.
    /// </summary>
    internal static class CreateAggregateVisitor
    {
        ...
        /// procedure to create an aggregate element from an existing aggregate object and an additional source
        /// element.
        /// </summary>
        /// <param name="expression">The <see cref="Expression"/> to visit.</param>
        /// <returns>The body of a JavaScript function for a stored procedure to create an aggregate element from
        /// an existing aggregate object and an additional source element.</returns>
            ...
            ParameterExpression currentParameter)
        {
            switch (expression.NodeType)
            {
                ...
                case ExpressionType.Constant:
                    return VisitSubExpression(
                        (ConstantExpression)expression, aggregateParameter, currentParameter);
                ...
                case ExpressionType.New:
                    return VisitSubExpression((NewExpression)expression, aggregateParameter, currentParameter);
